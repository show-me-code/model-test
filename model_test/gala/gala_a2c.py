...
class GALA_A2C():
    ...
    def update(self, rollouts):
        ...
        return value_loss.item(), action_loss.item(), dist_entropy.item(), self.mix_counter, buffer_time, train_time, \
               write_time, aggregate_time, aggregate_lock_time,aggregate_circle_time, aggregate_time_middle, self.gossip_buffer.aggregate_counter
